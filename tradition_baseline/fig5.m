...
Optimal_NOMA = [-5.66606907, -15.94919966, -21.868942625, -25.36415256, -27.00059453];
...
hold on
p7=plot(X_1, Optimal_NOMA,'-^','LineWidth',2, 'MarkerSize',6, 'MarkerEdgeColor', 'r', 'MarkerFaceColor','b');
hold on
ylabel('Decoding Error Probability $\lg (\mathcal{P}_1)$')
xlabel('$P_{\max}$')
legend('UE distribution $1$, $\kappa_1=0.1$, MA-TD3, NOMA','UE distribution $1$, $\kappa_1=0.1$, MA-TD3, OMA','$UE distribution $1$, \kappa_1=0.01$, MA-TD3, NOMA','$UE distribution $1$, \kappa_1=0.01$, MA-TD3, OMA','$UE distribution $1$, \kappa_1=0.1$, MA-DDPG,NOMA','$UE distribution $1$, \kappa_1=0.1$, MA-DDPG,OMA','UE distribution $2$, $\kappa_1=0.1$, MA-TD3, NOMA','UE distribution $2$, $\kappa_1=0.1$, MA-TD3, OMA', 'Traditional Optimization Method')
